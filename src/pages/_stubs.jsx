...
export const ProductDetail    = stub('Detalle de producto',    'Próximo commit — Paso 2')
export const Cart             = stub('Carrito',                 'Próximo commit — Paso 3')
...
export function NotFound() {
  return (
    <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '3rem 2rem', textAlign: 'center' }}>
      ...
      <Link to="/" style={{
        fontSize: '13px', borderBottom: '1px solid #e5e5e5', paddingBottom: '2px'
